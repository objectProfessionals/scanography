...
public class ScannerAsAngle extends Base {
    ...
    private String film = "ESB";
    private String weightFile = "FET";
    private double wmm = 400;
    private double hmm = wmm;
    private double strokemm = 9.56;
    private double bordermm = 20; //35;// 20
    ...
    private String weightsDir = hostOpDir + "WEIGHTS/";
    ...
    private String copyright = "\u00a9 www.lonGenArt.com";
    ...
    private void initImage() throws IOException {
        ...
        weightbi = ImageIO.read(new File(weightsDir + weightFileName));
    ...
    private void drawText(double x1, double y1) {
        ...
        try {
            ...
            AffineTransform at = new AffineTransform();
            AffineTransform tr = AffineTransform.getTranslateInstance(0, fh * 0.66);
    ...
    private void save() throws IOException {
        ...
        File f2 = new File(opDir + film + "_" + weightFile + "_w" + wmm + "_b" + bordermm + "_deg" + drawAngDeg + "str_" + strokemm + ".txt");
        f2.createNewFile();
